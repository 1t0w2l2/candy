        ...
        <form method="POST" action="update_institution.php">
            ...
            <div class="form-group">
                ...
                <input type="text" name="county" id="county"
                    value="<?php echo htmlspecialchars($institution['county']); ?>" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="phone" id="phone"
                    value="<?php echo htmlspecialchars($institution['phone']); ?>" required>
            </div>

            <div class="form-group">
                <label for="person_charge">負責人</label>
                <input type="text" name="person_charge" id="person_charge"
                    value="<?php echo htmlspecialchars($institution['person_charge']); ?>" required>
            </div>

            <div class="form-group">
                <label for="website">網站</label>
                <input type="url" name="website" id="website"
                    value="<?php echo htmlspecialchars($institution['website']); ?>" required>
            </div>
            ...
            <div class="form-group mb-4">
                <div style="display: flex; align-items: center;">
                    ...
                    <i class="bi bi-info-circle" tabindex="0" role="button" data-bs-toggle="popover"
