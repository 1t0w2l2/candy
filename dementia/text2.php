    ...
    <div class="s4-container">
        ...
        <div class="job-section">
            ...
            if (isset($_GET['action']) && $_GET['action'] === 'search' && !empty($searchInput)) {
                // 有搜尋條件時
                $searchInputEscaped = mysqli_real_escape_string($link, $searchInput);
        ...
        WHERE (a.share_title LIKE '%$searchInputEscaped%' 
               OR a.share_post LIKE '%$searchInputEscaped%')
